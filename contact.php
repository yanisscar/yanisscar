...
<html lang="en">
  ...
  <body>
	  ...
	  <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      <a class="navbar-brand" href="index.html">Trans <span> YanissCar</span></a>
	      ...
	      <div class="collapse navbar-collapse" id="ftco-nav">
            ...
            <li class="nav-item "><a href="vehicules.php" class="nav-link">véhicules</a></li>
            <li class="nav-item "><a href="voyages.php" class="nav-link">Voyages</a></li>
    ...
    <section class="hero-wrap hero-wrap-2 js-fullheight" style="background-image: url('images/trs.jpg');" data-stellar-background-ratio="0.5">
        		...
        		<div class="row mb-8">
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Addresse:</span> Rue berkane oujda</p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-2 d-flex">
			            ...
			            <p><span>Téléphone:</span> <a href="tel://1234567920">+212 661889171</a></p>
			          </div>
		          </div>
		          <div class="col-md-12">
		          	<div class="border w-100 p-4 rounded mb-4 d-flex">
			          	<div class="icon mr-4">
			          		<span class="icon-envelope-o"></span>
			          	</div>
			            <p><span>Email:</span> <a href="mailto:yanisscar@gmail.com">yanisscar@gmail.com</a></p>
			          </div>
		          </div>
		        </div>
          </div>
